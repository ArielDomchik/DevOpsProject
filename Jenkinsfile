    ...
    stages {
        ...
        stage('Deploy to EKS') {
            steps {
                ...
                sh "kubectl patch deployment pythonapp-deployment --type=json -p '[{\"op\": \"replace\", \"path\": \"/spec/template/spec/containers/0/image\", \"value\": \"arieldomchik/ariel:pythonapp5\"}]'"
